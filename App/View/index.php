...
<link href="../assets/css/paginaInicial.css" rel="stylesheet">
<!-- Le fav -->
...
<div class="container">
	...
	<div class="navbar-header">
		...
		<a class="navbar-brand" href="#top-section">SG-Odonto</a>
	</div>
</div>
</nav>
<!-- HOMEPAGE -->
...
<div class="jumbotron">
<div class="container py-5 my-5" style='top:100px;'>
        <div class="row">
                <div class="col-md-8 col-sm-6 col-xs-12 ">
                    <div class="pb-3"></div>
                    <h2>Create amazing landing page with globing template</h2>
                    <div class="py-2"></div>
                    <p>It is a long established fact that a reader will be of a page when established fact looking at its layout. Maecenas class semper class semper sollicitudin lectus lorem iaculis imperdiet aliquam.</p>
                    <div class="py-2"></div>
                    <button type="button" class="btn btn-outline-light">Get More Details</button>
                </div>
